...
# - v5: only most relevant parameters iterated
...
def load_config() -> Config:
    return Config(
        ...
        # defaults podle dosavadních výsledků
        ...
        max_distance_from_support_pct=env_float("MAX_DISTANCE_FROM_SUPPORT_PCT", 0.010),
...
GRID_CONFIG: Dict[str, List[Any]] = {
    "trigger_volume_vs_setup_avg_min": [2.5, 2.8],
    "trigger_buy_ratio_min": [0.55, 0.58],
    "accumulation_buy_ratio_min": [0.65, 0.67],
    "max_distance_from_support_pct": [0.008, 0.010],
    "setup_bars": [6, 8],
    "compression_bars": [4, 5],
}
